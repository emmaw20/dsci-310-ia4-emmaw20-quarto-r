...
![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-prov out.width="65%" fig.cap="Horse populations for the province with the largest standard deviation."}


In @fig-prov  we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
